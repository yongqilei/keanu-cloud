...
public class CustomUserInfoTokenServices implements ResourceServerTokenServices {
	...
	private final Logger log = LoggerFactory.getLogger(CustomUserInfoTokenServices.class);
	...
	private OAuth2Request getRequest(Map<String, Object> map) {
		...
		Set<String> scope = new LinkedHashSet<String>(request.containsKey("scope") ?
						(Collection<String>) request.get("scope") : Collections.emptySet());
		
		return new OAuth2Request(null, clientId, null, true, scope, null, null, null, null);
	}
	...
	private Map<String, Object> getMap(String path, String accessToken) {
		...
		try {
			...
			this.log.info("Could not fetch user details: " + ex.getClass() + ", "
					+ ex.getMessage());
